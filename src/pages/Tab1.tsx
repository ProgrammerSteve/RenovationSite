    ...
    <IonPage>
      <IonContent color="medium" fullscreen>
        <IonCard color="primary" className="ion-margin">
          ...
          <IonItem color="primary">
          <IonIcon size="small" icon={ callOutline} />
          ...
          <IonIcon size="small" icon={ locationOutline} />
            <IonLabel> 820 Daffodil, Los Fresnos, TX 78566</IonLabel>
          </IonItem>
            ...
            <IonRow className="ion-text-center">
              <IonCol size="12" color="primary">
                <IonRow>
                  ...
                  Zaya Renovations is a family owned renovation company serving
                  the RGV locality. With our passion for home renovation, we hope to 
                  service your needs and win your loyalty. Have questions? Receiving
                  a quote is free and easy!
                </IonLabel>
                </IonRow>
                <IonRow>
                  <IonButton id="quoteBtn" color="dark"  href="/tab3">Free Quote</IonButton>
                </IonRow>
              ...
              <IonCol color="primary" size="12">
                ...
                <IonGrid className="servicelist">
                  ...
                  <IonRow>
                  <IonCol>
                    <IonItem color="primary" className="serviceItem">
